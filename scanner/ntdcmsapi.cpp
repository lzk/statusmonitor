...
//    }
    ...
    m_ntdColor.HTMediaI		= 5; //Input Image Media : 5:Nature Scan
    m_ntdColor.HTMediaO		= mediaO; //Output Image Media: 0:Default(monitor)
    m_ntdColor.HTResolute	= resolute;
    m_ntdColor.HTDescreen	= 0; //For descreen quality 0:skip, 1:Fine Press, 2:Magazine, 3:News Paper
    ...
    m_ntdColor.HTQualityY	= 0x80; //B/W scan threshold
